...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_count(self):
        """Test that count properly countss objects"""


class TestDBStorageFuncs(unittest.TestCase):
